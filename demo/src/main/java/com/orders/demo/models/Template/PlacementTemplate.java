...
public class PlacementTemplate extends Template {
    ...
    public PlacementTemplate(Language language, String Name, String Product) {
        ...
        textLanguages.put(Language.ENGLISH,
                "Dear %s, your booking of the products %s is confirmed. Thanks for using our store :)");
        textLanguages.put(Language.FRENCH,
                "Cher %s, votre réservation des produits %s est confirmée. Merci d'utiliser notre boutique :)");
